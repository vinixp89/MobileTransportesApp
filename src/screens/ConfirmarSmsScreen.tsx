...
// cadastro poder recomeçar de outra conta.
export default function ConfirmarSmsScreen() {
  ...
  // Manda o código assim que a tela abre — o motorista/cliente não precisa apertar nada pra receber
  // o primeiro SMS.
  useEffect(() => {
    handleEnviarCodigo()
  }, [])
  ...
  async function handleConfirmar() {
    ...
    try {
      ...
      // Sem navigation daqui — assim que o perfil recarregado trouxer telefoneVerificado=true, o
      // RootNavigator troca sozinho pra Home.
    } catch (error) {
      setErro(extrairMensagemErro(error))
    } finally {
